...
DT::datatable(round_df(type,3), class = 'table-bordered', options = list(searching = FALSE,pageLength = 10,lengthMenu = c(5, 10, 15, 20), scrollX = F), caption = htmltools::tags$caption(
  style = 'caption-side: top; text-align: center;',
