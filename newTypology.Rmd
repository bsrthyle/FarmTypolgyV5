...
author: 
  - name: '[Bisrat H. Gebrekidan*](mailto:bisrat.gebrekidan@ilr.uni-bonn.de)'
  - name: Dr. Sebastian Rash
  - name: Prof. Dr. Thomas Heckelei
    affiliation: '<i class="fas fa-university" style="padding-right: 0.7em;"></i>  [ILR, University of Bonn](https://www.ilr1.uni-bonn.de/en)'
date: "6/2/2017"
output: 
...
ggplotly(p)%>%
  layout(title="Entry to Wetland Farming")
```
